...
export default function DoctorActivationProcessDetails() {
  ...
  useEffect(() => {
    ...
    getActivationFormById(
      ...
      (success) => {
        updateLoading(false);
        updateDoctorDetails(success.data.doctorDetails);
  ...
  const handleBack = () => {
    navigate(ROUTES.DOCTORSACTIVATIONPROCESS);
  };
            ...
            <div className="my-3">
              ...
              <ul className="f-poppins-16px fw-500">
                <li className="d-flex my-2">
                  ...
                  <div className="status-box-blue mx-4">{t("doctor")}</div>
                </li>
                <li className="d-flex my-2">
                ...
                <li className="d-flex my-2">
                  ...
                  <div className="mx-4">{doctorDetails?.phoneNumber}</div>
                </li>{" "}
                <li className="d-flex my-2">
                  <div className="fw-500">{t("email")}:</div>
                  <div className="mx-4">{doctorDetails?.email}</div>
                </li>
              </ul>
            </div>
            <div className="my-3">
